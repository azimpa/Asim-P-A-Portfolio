  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycbwrczWW4XMdkXv8-igH1zzSHeXOyLw-jejAkHMHfomSbr8Aog_3D2qTRtB4yI5mR9f73w/exec",
        {
          method: "POST",
          headers: {
        ...
        <div className="hidden xl:flex flex-col m-auto p-10">
          ...
          <div className="flex flex-col mt-4 md:mt-10 gap-y-3 ">
            <div className="flex items-center gap-2 ">
              ...
              <div>muhammedasim.pa@gmail.com</div>
            </div>
            <div className="flex items-center gap-2">
              <PhoneIcon size={18} className="text-accent" />
              <div>+91 7025838788</div>
            </div>
            <div className="flex items-center gap-2">
